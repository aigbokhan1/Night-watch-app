...
public class ExpenseFilterAdapter extends RecyclerView.Adapter<ExpenseFilterAdapter.MyViewHolder> {
    ...
    public ExpenseFilterAdapter(Context context, HashMap<Integer, Filter> filters, RecyclerView filterValuesRV) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        myViewHolder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                filterValuesRV.setAdapter(new ExpenseFilterValuesAdapter(context, position));
                selectedPostion = position;
                notifyDataSetChanged();
            }
        });

        filterValuesRV.setAdapter(new ExpenseFilterValuesAdapter(context, selectedPostion));
