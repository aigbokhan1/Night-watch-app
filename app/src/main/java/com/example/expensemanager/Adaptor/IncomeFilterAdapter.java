...
public class IncomeFilterAdapter extends RecyclerView.Adapter<IncomeFilterAdapter.MyViewHolder> {
    ...
    public IncomeFilterAdapter(Context context, HashMap<Integer, Filter> filters, RecyclerView filterValuesRV) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        myViewHolder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                filterValuesRV.setAdapter(new IncomeFilterValuesAdapter(context, position));
                selectedPostion = position;
                notifyDataSetChanged();
            }
        });

        filterValuesRV.setAdapter(new IncomeFilterValuesAdapter(context, selectedPostion));
